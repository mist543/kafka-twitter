...
```PowerShell
java -cp target/kafka-twitter-1.0-SNAPSHOT-jar-with-dependencies.jar northwest.missouri.red.chaitra.kafka.DefaultConsumer
```
...
```PowerShell
java -cp target/kafka-twitter-1.0-SNAPSHOT-jar-with-dependencies.jar northwest.missouri.red.chaitra.kafka.DefaultProducer
```
